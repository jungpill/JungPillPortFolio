    ...
    return(
        ...
        >
            <CoverLetterWrapper>
                ...
                <Text>
                졸업작품 진행 당시 팀장을 맡고 있었던 저는 팀원들과 회의를 통해 요구사항 분석 작업을 완료한 후 개발을 진행 하였습니다.
                ...
                있었고 모든 기능을 계획한 일정 내에 구현할 수 있었습니다. 이러한 과정 덕분에 저희 팀은 졸업
                작품 경진대회에서 좋은 성과를 거둘 수 있었으며 추후 학교 측에서 특허 출원 제안까지 받게 되었습니다. 
                해당 경험을 통해서 개발만 잘하는 개발자보다는 개발뿐 아니라 팀원들과 잘 협력하며
