    ...
    return(
        ...
        >
            <CoverLetterWrapper>
                ...
                알 수 없는 이유로 계속적인 네트워크 오류가 발생하였습니다. 해당 오류를 해결하기 위해 일주일간 계속적인 코드 수정과 네트워크 창 분석을 통해 
                크롬 브라우저에서 쿠키가 제대로 삭제되지 않는다는 것을 알아내 해결한 경험이 있습니다. 
                이 경험을 통해 복잡한 문제를 해결하는데 노력과 끈기가 얼마나 중요한지 깨닫게 되었고 만약 귀사에 입사하여 새로운 문제를 맞닥뜨리더라도 
                노력과 끈기로 극복해 나가는 모습을 보여드리겠습니다.

                제 성격의 단점은 한 가지 문제에 과도하게 몰입하는 경향입니다.
                프로젝트를 진행하며 버그를 해결하다 밤늦게까지 작업해 다음날 컨디션이 저하된 경험이 있습니다.최근에는 
                이런 성향을 줄이고자 문제가 잘 해결되지 않으면 잠시 멈추고 현재 상황을 정리한 뒤 팀원이나 멘토에게 조언을 구하는 규칙을 만들었습니다. 
